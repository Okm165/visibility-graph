...
def toVertecies(points):
    """ Parsing function from points generated by matplotlib to Vertex objects, returns Vertex list """
    ret = []
    for point in points:
        ret.append(Vertex(point[0], point[1]))
    return ret

def toEdges(edges):
    """ Parsing function from edges generated by matplotlib to Edge objects, returns Edge list """
    ret = []
    for edge in edges:
        ret.append(Edge(Vertex(edge[0][0], edge[0][1]),Vertex(edge[1][0], edge[1][1])))
    return ret